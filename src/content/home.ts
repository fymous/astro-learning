...
const homeContentRaw: Record<Locale, HomeContent> = {
  en: {
    ...
    trust: {
      ...
      title: "Trusted by",
      titleAccent: "40+ enterprise brands",
      sub: "From flagship retail chains to manufacturing plants and university campuses — leading Indian operators turn their existing CCTV into a business advantage with ShopEye.",
      stats: [
        { value: "40+", label: "enterprise brands" },
        { value: "1,200+", label: "locations live" },
        { value: "25,000+", label: "cameras under analysis" },
      ],
      logos: [
        { name: "Shoppers Stop", industry: "Retail" },
        { name: "FabIndia", industry: "Retail" },
        { name: "Reliance Trends", industry: "Retail" },
        { name: "Croma", industry: "Retail" },
        { name: "V-Mart", industry: "Retail" },
        { name: "Spencer's", industry: "Retail" },
        { name: "Style Bazaar", industry: "Retail" },
        { name: "Ratnadeep", industry: "Retail" },
        { name: "1India Family Mart", industry: "Retail" },
        { name: "Heritage Fresh", industry: "Retail" },
        { name: "Apollo Hospitals", industry: "Consumer Services" },
        { name: "Lakme Salon", industry: "Consumer Services" },
        { name: "VLCC", industry: "Consumer Services" },
        { name: "Cult.fit", industry: "Consumer Services" },
        { name: "Naturals Salon", industry: "Consumer Services" },
        { name: "Burger King", industry: "QSR" },
        { name: "Haldiram's", industry: "QSR" },
        { name: "Chai Point", industry: "QSR" },
        { name: "Theobroma", industry: "QSR" },
        { name: "A2B", industry: "QSR" },
        { name: "Zepto", industry: "Dark Stores" },
        { name: "KisanKonnect", industry: "Dark Stores" },
        { name: "Otipy", industry: "Dark Stores" },
        { name: "Rebel Foods", industry: "Cloud Kitchens" },
        { name: "Mojo Pizza", industry: "Cloud Kitchens" },
        { name: "Godrej", industry: "Manufacturing" },
        { name: "Havells", industry: "Manufacturing" },
        { name: "Asian Paints", industry: "Manufacturing" },
        { name: "Berger Paints", industry: "Manufacturing" },
        { name: "Symphony", industry: "Manufacturing" },
        { name: "Stove Kraft", industry: "Manufacturing" },
        { name: "Delhivery", industry: "Logistics" },
        { name: "BlueDart", industry: "Logistics" },
        { name: "Mahindra Logistics", industry: "Logistics" },
        { name: "Shadowfax", industry: "Logistics" },
        { name: "LetsTransport", industry: "Logistics" },
        { name: "Manipal University", industry: "Education" },
        { name: "Amity University", industry: "Education" },
        { name: "Allen Career Institute", industry: "Education" },
        { name: "Plaksha University", industry: "Education" },
      ],
    },
    pillars: [
  ...
  hi: {
    ...
    trust: {
      eyebrow: "स्केल पर भरोसेमंद",
      title: "भरोसेमंद",
      titleAccent: "40+ एंटरप्राइज़ ब्रांड्स",
      sub: "फ्लैगशिप रिटेल चेन से लेकर मैन्युफैक्चरिंग प्लांट और यूनिवर्सिटी कैंपस तक — भारत के प्रमुख ऑपरेटर ShopEye के साथ अपने मौजूदा CCTV को व्यावसायिक बढ़त में बदल रहे हैं।",
      stats: [
        { value: "40+", label: "एंटरप्राइज़ ब्रांड्स" },
        { value: "1,200+", label: "लाइव स्थान" },
        { value: "25,000+", label: "कैमरे विश्लेषण में" },
      ],
      logos: [
        { name: "Shoppers Stop", industry: "रिटेल" },
        { name: "FabIndia", industry: "रिटेल" },
        { name: "Reliance Trends", industry: "रिटेल" },
        { name: "Croma", industry: "रिटेल" },
        { name: "V-Mart", industry: "रिटेल" },
        { name: "Spencer's", industry: "रिटेल" },
        { name: "Style Bazaar", industry: "रिटेल" },
        { name: "Ratnadeep", industry: "रिटेल" },
        { name: "1India Family Mart", industry: "रिटेल" },
        { name: "Heritage Fresh", industry: "रिटेल" },
        { name: "Apollo Hospitals", industry: "कंज़्यूमर सर्विसेज़" },
        { name: "Lakme Salon", industry: "कंज़्यूमर सर्विसेज़" },
        { name: "VLCC", industry: "कंज़्यूमर सर्विसेज़" },
        { name: "Cult.fit", industry: "कंज़्यूमर सर्विसेज़" },
        { name: "Naturals Salon", industry: "कंज़्यूमर सर्विसेज़" },
        { name: "Burger King", industry: "QSR" },
        { name: "Haldiram's", industry: "QSR" },
        { name: "Chai Point", industry: "QSR" },
        { name: "Theobroma", industry: "QSR" },
        { name: "A2B", industry: "QSR" },
        { name: "Zepto", industry: "डार्क स्टोर" },
        { name: "KisanKonnect", industry: "डार्क स्टोर" },
        { name: "Otipy", industry: "डार्क स्टोर" },
        { name: "Rebel Foods", industry: "क्लाउड किचन" },
        { name: "Mojo Pizza", industry: "क्लाउड किचन" },
        { name: "Godrej", industry: "मैन्युफैक्चरिंग" },
        { name: "Havells", industry: "मैन्युफैक्चरिंग" },
        { name: "Asian Paints", industry: "मैन्युफैक्चरिंग" },
        { name: "Berger Paints", industry: "मैन्युफैक्चरिंग" },
        { name: "Symphony", industry: "मैन्युफैक्चरिंग" },
        { name: "Stove Kraft", industry: "मैन्युफैक्चरिंग" },
        { name: "Delhivery", industry: "लॉजिस्टिक्स" },
        { name: "BlueDart", industry: "लॉजिस्टिक्स" },
        { name: "Mahindra Logistics", industry: "लॉजिस्टिक्स" },
        { name: "Shadowfax", industry: "लॉजिस्टिक्स" },
        { name: "LetsTransport", industry: "लॉजिस्टिक्स" },
        { name: "Manipal University", industry: "शिक्षा" },
        { name: "Amity University", industry: "शिक्षा" },
        { name: "Allen Career Institute", industry: "शिक्षा" },
        { name: "Plaksha University", industry: "शिक्षा" },
      ],
    },
    pillars: [
